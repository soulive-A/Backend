...
-- 상품모델 더미데이터
INSERT INTO soullive.product (product_id, user_id, brand, characteristic, company, product)
VALUES
    (1, 1, 'LG 시그니처', '올인원 세탁 방식', 'LG 전자', 'LG 시그니처 세탁건조기');

INSERT INTO soullive.brand_image (brand_image_id, product_id, brand_image)
VALUES
    (1, 1, '프리미엄'),
    (2, 1, '프로페셔널');

INSERT INTO soullive.product_image ( product_image_id, product_id, product_image)
VALUES
    (1, 1, '세련됨'),
    (2, 1, '편리함'),
    (3, 1, '혁신적인');

INSERT INTO soullive.gender (gender_id, product_id, gender_type)
VALUES
    (1, 1, 'MALE'),
    (2, 1, 'FEMALE');

INSERT INTO soullive.age (age_id, product_id, age_type)
VALUES
    (1, 1, 'TEN'),
    (2, 1, 'TWENTY'),
    (3, 1, 'THIRTY'),
...
INSERT INTO soullive.targetrange (range_id, product_id, range_value)
VALUES
    (1, 1, '고소득층'),
    (2, 1, '1인가구'),
    (3, 1, '주부');
